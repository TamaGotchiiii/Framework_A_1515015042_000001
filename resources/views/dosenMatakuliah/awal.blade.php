...
<div class="panel panel-default">
	...
	<table class="table">
		...
		<tbody>
			...
			<tr>
				<td>{{$x++}}</td>
				<td>{{$dosen->matakuliah->title or 'nama kosong'}}</td>
				<td>{{$dosen->dosen->nama or 'nama kosong'}}</td>
				<td>
					<div class="btn-group" role="group">
					<a href="{{url('dosen_matakuliah/edit/'.$dosen->id)}}" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="top" title="Ubah"><i class="fa fa-pencil"></i></a>
					...
					<a href="{{url('dosen_matakuliah/hapus/'.$dosen->id)}}" class="btn btn-danger btn-xs" data-placement="top" title="Hapus"><i class="fa fa-remove"></i></a>
					</div>
				</td>
			</tr>
			@endforeach
